    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="地址" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-textarea placeholder="请输入地址" :rows="4" v-decorator="[ 'address', validatorRules.address ]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        that.$nextTick(() => {
          that.form.setFieldsValue(pick(this.model,'username','sex','realname','email','phone','activitiSync','workNo','telephone','address','post'))
        });
        // 调用查询用户对应的部门信息的方法
